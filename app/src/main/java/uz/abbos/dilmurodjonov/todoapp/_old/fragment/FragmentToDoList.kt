...
import uz.abbos.dilmurodjonov.todoapp._old.ToDoAdapter
...
class FragmentToDoList : Fragment() {
    ...
    override fun onCreateView(
        ...
        adapter = ToDoAdapter { item ->
            val action =
                uz.abbos.dilmurodjonov.todoapp.fragment.FragmentToDoListDirections.actionFragmentToDoListToFragmentAddToDo()
            action.toDoId = item
